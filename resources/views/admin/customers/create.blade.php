            ...
            @csrf
                <div class='form-groups'>
                    <div class="row">
                        ...
                        <div class="col-md-6"><input type="text" name="name" class="form-control" required>
                        </div>
                    </div><br>
                    <div class='form-groups'>
                    <div class="row">
                ...
                <div class='form-groups'>
                    <div class="row">
                        <label class="col-md-3">Customer Phone</label>
                ...
                <div class='form-groups'>
                    <div class="row">
                        ...
                        <div class="col-md-6"><input type="text" name="company" class="form-control">
                        </div>
                    </div>
                </div><br>
                <div class='form-groups'>
                    <div class="row">
                        ...
                        <div class="col-md-6"><input type="text" name="tin" class="form-control">
                        </div>
                    </div>
                </div><br>
                <div class="form-groups">
