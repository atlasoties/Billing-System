                    ...
                    <form action="{{ route('invoices.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" id="client" name="name" class="form-control" value="{{$c->name}}" required >
                                </div>                               <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" id="client" name="phone" class="form-control"  value="{{$c->phone}}">
                                </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" id="client" name="companyName" class="form-control" value="{{$c->companyName}}">
                                </div>
                                <div class="col">
                                    <label for="inputName" class="control-label">Tin No</label>
                                    <input type="text" id="client" name="tinNo" class="form-control" value="{{$c->tinNo}}">
                                </div>
                                <div class="col">
                                    <label for="inputName" class="control-label">Address</label>
                                    <input type="text" id="client" name="address" class="form-control" value="{{$c->address}}">
                                </div>
                            </div>
